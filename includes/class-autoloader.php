...
class MCP_Autoloader {
    ...
    private static $class_map = array(
        ...
        'Themer'            => 'services/class-themer.php',
        'Performance_Analyzer'=> 'services/class-performance-analyzer.php',
        'Security_Scanner'   => 'services/class-security-scanner.php',
        ...
        'Audit_Page'        => 'admin/class-audit-page.php',
